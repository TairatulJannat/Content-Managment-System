...
?>
        ...
        while ($row =mysqli_fetch_assoc($select_categories_id)){
         ...
         <td><?php echo "<img width='100' src='../images/$post_image' alt='image'>" ?></td>
         ...
         <td><?php echo  "<a href='posts.php?reset={$post_id}'> $post_view_count</a>"?></td>
         <td><?php echo "<a href='posts.php?source=edit_post&p_id={$post_id}'> Edit</a>" ?></td>
         <td><?php echo "<a onClick=\"javascript: return confirm('Are you want to sure to delete?'); \" href='posts.php?delete={$post_id}'> Delete</a>" ?></td>
         </tr>
<?php } ?>
</tbody>
</table>
